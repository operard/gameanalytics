...
verbose = False
debug = False
data_path = '/home/opc/new_data_twitter/keywords'
data_csv_path = '/home/opc/new_data_twitter_csv/keywords'
...
def scrape_from_keyword(keyword, since, until):
	...
	fname = str.format("{}_{}_{}.json", keyword,since,until)
	...
	if len(tweets_df.index) > 0:
		...
		# Save
		fname = str.format("{}_{}_{}.csv", keyword,since,until)
		...
		fname = str.format("{}_{}_{}_replies.csv", keyword,since,until)
		tweets_save = os.path.join(data_csv_path, fname)
...
def main():
    ...
    # data = process_yaml()
    # Execute Method
    scrape_from_keyword(args.keyword, args.Since, args.Until)
    print("Done!")
    #
    ...
    print('Execution Time to extract keyword twitter : %d hour:%d min:%d sec' %(hours,minutes,seconds))
